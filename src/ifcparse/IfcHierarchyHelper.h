...
namespace {
    ...
    IfcEntityList::ptr get_children_of_relation(Ifc4x3::IfcRelContainedInSpatialStructure* t) {
    return t->RelatedElements()->generalize();
    }
    ...
    void set_children_of_relation(Ifc4x3::IfcRelContainedInSpatialStructure* t, IfcEntityList::ptr& cs) {
